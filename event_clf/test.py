...
from models import AUDIO_CLIP
from util.utils import PNW_loader, load_model, downstream_class3
...
def load_SeisCLIP(main_model_path, sub_model_path):
    ...
    finetune_model = AUDIO_CLIP(
        embed_dim=384, text_input=8, text_width=512, text_layers=2, spec_tdim=600, spec_fdim=50, spec_fstr=10,
        spec_model_size='small224', device_name=device).to(device)
    # load model
