...
def main(inp_name):
    ...
    output_writer.writerow(['network_code', 'receiver_code', 'receiver_type', 'receiver_latitude', 'receiver_longitude',
                            ...
                            'source_distance_deg', 'source_distance_km', 'back_azimuth_deg', 'snr_db',
                            'coda_end_sample',
                            'trace_start_time', 'trace_category', 'trace_name'])
    csvfile.flush()
    print('output files have been generated!')

    for h5name in glob.glob('/data/jyzheng/datasets/stead/chunk[2-6].hdf5'):
...
if __name__ == '__main__':
    ...
    inp_name = "/data/jyzheng/SeisCLIP/datasets/stead/merged"
    main(inp_name)
